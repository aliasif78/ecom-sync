                ...
                <tr key={product._id} className="group transition-all duration-300 hover:bg-white/5">
                  ...
                  <td className="px-8 py-5 text-right text-sm font-medium whitespace-nowrap">
                    <div className="flex items-center justify-end gap-3">
                      {/* 1. History Button (Ghost Style) */}
                      <button type="button" onClick={() => openHistoryModal(product)} className="group/history relative flex h-10 w-10 items-center justify-center rounded-lg border border-transparent text-slate-400 transition-all hover:border-indigo-500/30 hover:bg-indigo-500/10 hover:text-indigo-400" title="View History">
                        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          {/* Clock Hands + Circular Rim */}
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                      </button>

                      {/* 2. Edit Button (Ghost Style) */}
                      ...
                      {/* 3. Delete Button (Danger Ghost Style) */}
                      ...
                      {/* 4. Sync Button (Primary Action - Kept Prominent) */}
